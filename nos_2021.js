...
function createAndPopulateTable(data) {
   ...
   //     '2e Partij (lang)',
    ...
    async function fetchData() {
        try {
            const response = await fetch('https://faas-ams3-2a2df116.doserverless.co/api/v1/web/fn-99532869-f9f1-44c3-ba3b-9af9d74b05e5/default/getdata?year=2021&source=nos');
